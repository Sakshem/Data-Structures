//NOTE: A tree can only be created if any one of the two condition is fulfilled
//1) we have been given preorder and inorder traversal of that binary tree.
//2) we have been given postorder and inorder traversal of that binary tree.
#include <iostream>
#include <queue>
#include <stack>
